  ...
  export default {
    ...
    methods : {
      login () {
        ...
        googleUrl () {
          let url = 'https://accounts.google.com/o/oauth2/v2/auth?scope=openid%20profile%20email&response_type=token&client_id=930321456330-8867b5o93bk3aphairnhbokq7g8htqet.apps.googleusercontent.com&redirect_uri=http://localhost:8080/token';
